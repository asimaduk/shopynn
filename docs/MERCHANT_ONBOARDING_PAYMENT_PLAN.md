...
| 9 | Agent commission | **15%** one-time on assisted onboarding line; **10% residual** on every paid subscription month while serving agent; **0%** on add-on lines (unless policy changes later) |
...
| `commission_eligible` | `onboarding_15` \| `subscription_residual_10` \| `none` |
