			...
			>
				...
				<div className="relative z-10 w-full max-w-4xl">
					...
					<div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
						This effective Inventory Management System is essential for enhancing operational efficiency and achieving business growth. By using such a system, businesses can streamline their inventory processes, reduce costs, and improve customer satisfaction, ultimately leading to a more successful operation.
					</div>
