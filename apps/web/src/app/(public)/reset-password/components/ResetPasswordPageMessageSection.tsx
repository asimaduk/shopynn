		...
		>
			...
			<div className="relative z-10 w-full max-w-4xl">
				...
				<div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
					Shopynn is a platform for managing your inventory and orders. It is a cloud-based solution that allows you to track your inventory, orders, and customers.
				</div>
