...
/**
 * Users list header (aligned with Expenses and other control-panel list pages).
 */
function UsersHeader({
	...
	const blockReason =
		addBlockedReason ||
		`Your plan allows a limited number of users. Remove a user or upgrade to add another.`;
