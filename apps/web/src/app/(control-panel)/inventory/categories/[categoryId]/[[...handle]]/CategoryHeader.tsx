 ...
 * The category header.
 */
function CategoryHeader({ updateProcessing }) {
	...
	const [saveCategory] = useUpdateProductCategoryMutation();
	...
	const { name, thumbnail } = watch() as ProductCategory;

	function handleSaveProduct() {
		updateProcessing(true);
		// saveCategory(getValues() as EcommerceProduct);
		saveCategory(getValues())
			.then(()=> navigate('/inventory/categories'))
	...
	function handleCreateCategory() {
		updateProcessing(true);
		// createCategory(getValues() as EcommerceProduct)
