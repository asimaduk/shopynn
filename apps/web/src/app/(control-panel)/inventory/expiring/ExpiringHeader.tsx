...
function formatDateRange(dates: DateRange): string {
	if (!dates) return 'Filter by expiry date';
		...
		<div className="flex grow-0 flex-1 w-full items-center justify-between space-y-2 sm:space-y-0 py-6 sm:py-8">
			...
			>
				<div>
					...
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">Items expiring soon</Typography>
					<Typography
						variant="body1"
