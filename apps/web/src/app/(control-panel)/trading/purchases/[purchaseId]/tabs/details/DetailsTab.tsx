...
// import OrdersStatus from '../../../PurchasesStatus';
					...
					<table className="simple">
						<thead>
							<tr>
								...
								<th>
									<Typography className="font-semibold">Transaction ID</Typography>
								</th>
								<th>
						...
						<tbody>
							<tr>
								...
								<td>
									<span className="truncate">{purchase.payment_reference || 'N/A'}</span>
								</td>
								<td>
									<span className="truncate">{purchase.payment_type == 2 ? 'Momo':'Cash'}</span>
								</td>
								<td>
									<span className="truncate">{formatGhsCurrency(Number(purchase.total_amount ?? 0), 2, 2)}</span>
								</td>
								<td>
									<span className="truncate">{new Date(purchase.created_at).toDateString()}</span>
								</td>
							</tr>
						</tbody>
					</table>
