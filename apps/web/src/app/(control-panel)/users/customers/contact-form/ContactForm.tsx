...
const schema = z.object({
	...
	source: z.enum(['pos', 'account']).optional(),
...
function ContactForm(props: ContactFormProps) {
	...
	const { data: contact, isError, isLoading } = useGetContactsItemQuery(contactId, {
	...
	if (!isNew && contactId && contactId !== 'new') {
		...
		if (contact?.source === 'account') {
			return (
				<Box className="flex flex-col items-center justify-center min-h-[50vh] max-w-lg mx-auto p-8">
