...
const Header = ({ navigation, screen }) => {
    ...
    return (
        <View style={{ flexDirection: 'row', padding: 10, paddingTop: 10 + insets.top, backgroundColor: colors.background }}>
            <TouchableOpacity
                activeOpacity={0.7}
            ...
            >
                ...
                <Text style={{ fontFamily: 'FiraSans-SemiBold', fontSize: 13, marginLeft: 5, color: colors.textTertiary }}>
                    Search
                </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
                <Lucide name="bell" color={colors.text} size={20} />
            </TouchableOpacity>
        </View>
    );
};
