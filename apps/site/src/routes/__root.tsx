...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shopynn" },
      { name: "description", content: "Shopynn is a modern SaaS platform for streamlined inventory and customer ordering." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Shopynn" },
      { property: "og:description", content: "Shopynn is a modern SaaS platform for streamlined inventory and customer ordering." },
